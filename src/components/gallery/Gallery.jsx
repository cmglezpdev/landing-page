    ...
    return (
        ...
        <section className='gallery' id='gallery'>
            ...
            <div className='cars-gallery'>
                <CardCar 
                    img={`${resoursePathInProduction('/assets/gallery/ferrari.jpg')}`}
                    name='Ferrari'
                ...
                <CardCar
                    img={`${resoursePathInProduction('/assets/gallery/bmw.jpg')}`}
                    name='BMW'
                ...
                <CardCar
                    img={`${resoursePathInProduction('/assets/gallery/mercedes.jpg')}`}
                    name='Mercedes'
                ...
                <CardCar
                    img={`${resoursePathInProduction('/assets/gallery/audi.jpg')}`}
                    name='Audi'
                ...
                <CardCar
                    img={`${resoursePathInProduction('/assets/gallery/porsche.jpg')}`}
                    name='Porsche'
                ...
                <CardCar
                    img={`${resoursePathInProduction('/assets/gallery/lamborghini.jpg')}`}
                    name='Lamborghini'
                ...
                <CardCar
                    img={`${resoursePathInProduction('/assets/gallery/maserati.jpg')}`}
                    name='Maserati'
                ...
                <CardCar
                    img={`${resoursePathInProduction('/assets/gallery/bugatti.jpg')}`}
                    name='Bugatti'
                ...
                <CardCar
                    img={`${resoursePathInProduction('/assets/gallery/tesla.jpg')}`}
                    name='Tesla'
                ...
                <CardCar
                    img={`${resoursePathInProduction('/assets/gallery/toyota.jpg')}`}
                    name='Toyota'
                ...
                <CardCar
                    img={`${resoursePathInProduction('/assets/gallery/nissan.jpg')}`}
                    name='Nissan'
                ...
                <CardCar
                    img={`${resoursePathInProduction('/assets/gallery/mazda.jpg')}`}
                    name='Mazda'
                ...
                <CardCar
                    img={`${resoursePathInProduction('/assets/gallery/honda.jpg')}`}
                    name='Honda'
                ...
                <CardCar
                    img={`${resoursePathInProduction('/assets/gallery/lexus.jpg')}`}  
                    name='Lexus'
